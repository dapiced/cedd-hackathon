...
_FALLBACK_RESPONSE = {
    "fr": "Je suis là pour t'écouter. Peux-tu me dire comment tu te sens ?",
    "en": "I'm here to listen. Can you tell me how you're feeling?",
}
...
def build_ollama_request(
    ...
    Args:
        ...
        alert_level: DDEC alert level (0-3)
...
def get_llm_response(
    ...
    """
    system_prompt = get_system_prompt(alert_level, lang=lang)
    fallback_msg = _FALLBACK_RESPONSE.get(lang, _FALLBACK_RESPONSE["fr"])
